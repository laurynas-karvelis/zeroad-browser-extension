...
export const EVENT = {
  ...
  TAB_TRACKER: {
    PUBLISHER_DETECTED: "TAB_TRACKER:PUBLISHER_DETECTED",
    IS_ACTIVE_TAB_PUBLISHER: "TAB_TRACKER:IS_ACTIVE_TAB_PUBLISHER",
  },
  HEADER_INJECTION: {
  ...
  MESSAGING: {
    ...
    IS_ACTIVE_TAB_PUBLISHER: "MESSAGING:IS_ACTIVE_TAB_PUBLISHER",
  },
  POPUP: {
    ...
    CHECK_IF_ACTIVE_TAB_PUBLISHER_REQUEST: "POPUP:CHECK_IF_ACTIVE_TAB_PUBLISHER_REQUEST",
  },
  WEBSITE: {
    PING: "PING",
